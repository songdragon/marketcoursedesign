...
function N2ConfigBase() { 
    ...
    document.write('<link href="'+domain+'css/pop.css" type="text/css" rel="stylesheet">'+'');
    goN2LibMon.monitorLoad ("utilities");
    goN2LibMon.monitorLoad ("events");
    goN2LibMon.monitorLoad ("simplePopover");
    document.write('<script language="javascript" src="'+domain+'js/a_20051231.js" type="text/javascript"></script><\/script>'+'<script language="javascript" src="'+domain+'js/c_20051231.js" type="text/javascript"></script><\/script>'+'<script language="javascript" src="'+domain+'js/b_20051231.js" type="text/javascript"></script><\/script>'+'');
