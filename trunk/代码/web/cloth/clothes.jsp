...
<TABLE cellSpacing=0 cellPadding=0 width="100%"  height="100%" border=0>
	  ...
	  <%
		...
		String sql="select productsname,products_id from dresses";
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 >
		...
		<TD>
          <DIV class=adTitle0><A href=""><SPAN 
            ...
            src="../images/ll060828_lanmu.gif">衣裤精品</SPAN></A>
			</DIV>
			<div class=adTitle2>
            <TABLE id=UCAdRotate1_dlstRotate__ctl0__ctl0_dlstRotateItems 
            cellSpacing=4 cellPadding=0 border=0 width="100%">
			<tr>
			<td width="33%" align="center"><img src="../pic/cloth/1.bmp" height="140" width="160"></td>
			...
			<tr>
			<td width="33%" align="center"><a href="dressdetail.jsp?productid=0000000001" target="_blank">微可短裤</a></td>
			<td width="33%" align="center"><a href="dressdetail.jsp?productid=0000000004" target="_blank">Levi's T恤</a></td>
			<td width="33%" align="center"><a href="dressdetail.jsp?productid=0000000041" target="_blank">Levi's 长裤</a></td>
			</tr>
			</TABLE>
			</div>
</TD></TR></TBODY></TABLE>
